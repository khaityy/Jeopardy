...
class Jeopardy {
  layout(element) {
    make.QuestionIds = ["American Idol Fandom🎤", "How well do you know your toons?", "Live 📺 Debacles", "NBA, NFL, and MLB", "🎶 and Hollywood"]
  }
}
...
// STATE VALUES
make.currentAnswer = null;
make.score = 0;

// ELEMENTS
make.gameBoardElement = element.querySelector(".game-board");
make.gameSquareElement = element.querySelector(".game-square");
make.inputElement = element.querySelector("input[name=player]");
make.scoreElement = element.querySelector(".score-number");
make.questTextElement = element.querySelector(".quest-text");
...
const gameplay = new Jeopardy(document.querySelector(".game"), { 
});
